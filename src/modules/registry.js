...
export const mainModules = [
  ...
  },
  {
    ...
    description: 'فهرست کالاهای مرجع و مدیریت ساختار کالا (Product Master)',
  },
  {
    id: 'gahshomar',
    path: '/gahshomar',
  ...
  },
  {
    ...
    description: 'مدیریت کمپین‌های نگهداشت و جذب: پیام، نظرسنجی، فعالیت، اقدام فیزیکی و تبلیغات دیجیتال',
  },
  {
    id: 'pooyesh',
    path: '/pooyesh',
