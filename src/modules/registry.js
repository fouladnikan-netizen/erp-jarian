...
export const mainModules = [
  ...
  },
  {
    ...
    name: 'پویش',
    subtitle: 'فعالیت‌ها',
    description: 'ثبت و پیگیری تماس‌ها، جلسات، یادآورها و فعالیت‌های تیمی',
  },
  {
    id: 'ayeneh',
    path: '/ayeneh',
...
export const moduleData = {
  ...
  gahshomar: {
    kpis: [
      ...
      { label: 'وظایف معوق', value: '۴', trend: '-۲', trendDir: 'down' },
      { label: 'جلسات این هفته', value: '۹', trend: '+۱', trendDir: 'up' },
      { label: 'در انتظار پاسخ', value: '۱۱', trend: 'پیگیری', trendDir: 'up' },
    ],
    filters: ['همه', 'نامه', 'وظیفه', 'جلسه', 'یادآور'],
    searchPlaceholder: 'جستجو در دبیرخانه...',
    primaryAction: 'ثبت نامه جدید',
    secondaryActions: ['تقویم', 'گزارش'],
    tableTitle: 'فهرست مکاتبات و وظایف',
    columns: ['موضوع', 'نوع', 'فرستنده/مسئول', 'مهلت', 'وضعیت'],
    rows: [
      { cells: ['درخواست استعلام قیمت', 'نامه', 'فولاد پارس', '۱۴۰۴/۰۱/۱۸', 'tag:pending:در انتظار'], id: 1 },
      { cells: ['پیگیری قرارداد', 'وظیفه', 'علی رضایی', '۱۴۰۴/۰۱/۱۶', 'tag:active:جاری'], id: 2 },
      { cells: ['جلسه بررسی فروش', 'جلسه', 'تیم فروش', '۱۴۰۴/۰۱/۱۵', 'tag:success:انجام شد'], id: 3 },
    ],
  },
  pooyesh: {
    kpis: [
      { label: 'فعالیت‌های امروز', value: '۱۸', trend: '+۳', trendDir: 'up', variant: 'accent' },
      { label: 'تماس‌های برنامه‌ریزی', value: '۶', trend: '۲ انجام', trendDir: 'up' },
      { label: 'جلسات این هفته', value: '۴', trend: '۱ باقی', trendDir: 'up' },
      { label: 'عقب‌افتاده', value: '۳', trend: '-۱', trendDir: 'down', variant: 'danger' },
    ],
    filters: ['همه', 'تماس', 'جلسه', 'یادداشت', 'پیگیری'],
    searchPlaceholder: 'جستجو در فعالیت‌ها...',
    primaryAction: 'ثبت فعالیت',
    secondaryActions: ['تقویم فعالیت', 'خروجی'],
    tableTitle: 'فهرست فعالیت‌ها',
    columns: ['عنوان', 'نوع', 'مربوط به', 'تاریخ', 'وضعیت'],
    rows: [
      { cells: ['تماس پیگیری سفارش', 'تماس', 'فولاد پارس', '۱۴۰۴/۰۱/۱۵', 'tag:success:انجام شد'], id: 1 },
      { cells: ['ارسال پیش‌فاکتور', 'پیگیری', 'صنایع فلزی کرمان', '۱۴۰۴/۰۱/۱۶', 'tag:active:جاری'], id: 2 },
      { cells: ['جلسه هماهنگی', 'جلسه', 'تیم فروش', '۱۴۰۴/۰۱/۱۷', 'tag:pending:برنامه‌ریزی'], id: 3 },
    ],
  },
  ayeneh: {
    kpis: [
  ...
  shirazeh: {
    ...
    rows: [
      ...
      { cells: ['برندینگ سازمانی', 'لوگو و رنگ‌های جریان', '۱۴۰۴/۰۱/۰۵', 'tag:active:فعال'], id: 2 },
