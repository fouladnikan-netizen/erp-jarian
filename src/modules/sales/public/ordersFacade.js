/**
 * Sales public Order query surface.
 * Cross-module consumers must import from here — not useSalesStore / SalesOrdersContext.
 */
...
export function useOrders() {
  return useSalesStore((s) => s.orders);
}

export function useCreateOrderDirect() {
  return useSalesStore((s) => s.createOrderDirect);
}

export function useOrdersForCompany(companyId) {
  return useSalesStore((s) => {
