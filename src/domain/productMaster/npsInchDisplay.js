/**
 * NPS inch display (FE preview mirror). Postgres + backend generatedName are SoR.
 * See backend/src/domain/productMaster/npsInchDisplay.js.
 * Category لوله Types (except لوله داربست) bind size_pipe (اینچ).
