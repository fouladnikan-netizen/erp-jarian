...
import { listActivitiesForCompanySubject as listCompanyActivities } from '../../tasks/public/companyActivityReferences.js';
import { findOrdersForCompany } from '../../sales/public/companyOrderReferences.js';
...
export async function recomputeCustomerLifecycle(companyId, opts) {
  ...
  const [activities, orders] = await Promise.all([
    listCompanyActivities(companyId, { limit: 200 }, client),
    findOrdersForCompany(companyId, { limit: 200 }, client),
  ]);
